import { View, Text, TouchableOpacity, Platform, DateTimePicker, useState } from "../../constants/Imports";
  ...
  return (
    <View className="flex p-2 flex-row">
      <TouchableOpacity onPress={handlePress}
        className={`rounded-lg text-whi/*  */te text-base ${Platform.OS === "android" && "px-2 py-1 justify-center bg=[#474747"}`}>
