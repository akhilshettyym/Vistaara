    ...
    return (
        <SafeAreaView style={[
            ...
            <ScrollView className="h-full">
                ...
                <View className="flex-row mt-2 p-2">
                ...
                <View className="border m-2 p-2 border-[#1ED760] rounded-lg">
                    <View className="flex-row m-2 p-2 justify-end items-center">
                    ...
                    <View className="flex-row m-2 bg-[#474747] rounded-lg p-2 justify-end items-center">
                        <View className="flex-1 flex-row">
