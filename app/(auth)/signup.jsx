...
//                             }) => (
//                                 <>
//                                     <Text className="text-[#1ED760] mt-2 mb-2 font-semibold">
//                                         *Name
//                                     </Text>
//                                     <TextInput
...
//                                     <Text className="text-[#1ED760] mt-4 mb-2 font-semibold">
//                                         *Email
//                                     </Text>
//                                     <TextInput
//                                         className="h-11 border border-white text-white rounded px-2 bg-white/10"
...
//                                     {/* 👇 disable button & show loader while signing up */}
//                                     <TouchableOpacity
...
//                                     Already a User?{" "}
//                                 </Text>
//                                 <Text className="text-base font-semibold underline text-[#1ED760]">
//                                     Sign In
//                                 </Text>
//                             </TouchableOpacity>

//                             <TouchableOpacity
//                                 className="p-3 bg-[#1ED760] rounded-lg mt-8 flex flex-row justify-center items-center my-3"
//                                 onPress={handleGuest}
//                             >
